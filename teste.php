                ...
                <div class="card">
                    <div class="card-header">
                        <h4>Detalhes do aluno
                            <a href="student-create.php" class="btn btn-primary float-end">Adicionar conteiner</a>
                        </h4>
                    </div>
                    <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                   <a href="edConteiner.php?idContainer=<?= $container['idContainer']; ?>" class="btn btn-success btn-sm">Editar</a>
                                                    <form action="delConteiner.php" method="POST" class="d-inline">
                                                        <button type="submit" name="delete_student" value="<?=$container['idContainer'];?>" class="btn btn-danger btn-sm">Deletar</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php
